...
class GeometryTest extends GEOSTest
{
    ...
    public function testGeometry_interpolate()
    {
        ...
        try {
            ...
            $this->assertContains('Argument', $e->getMessage());
        }
    ...
    public function testGeometry_offsetCurve()
    {
        ...
        $this->assertEqualsAny(array(
          'LINESTRING (0 -10, 100 -10, 102 -10, 104 -9, 106 -8, 107 -7, 108 -6, 109 -4, 110 -2, 110 0, 110 100)',
          'LINESTRING (0 -10, 100 -10, 107 -7, 110 0, 110 100)',
          'LINESTRING (110 100, 110 0, 107 -7, 100 -10, 0 -10)'
        ), $writer->write($b)); // Linestring changed twice first between 3.9 and 3.11 then 3.12.1
